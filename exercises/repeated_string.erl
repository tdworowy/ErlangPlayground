%% @author Tomasz
%% @doc Lilah has a string s of lowercase English letters that she repeated infinitely many times.Given an integer n find and print the number of letter a's in the first  letters of Lilah's infinite string.
%%s1 = "aba"
%%n1 = 10 
%%output 7
%%s2 = "a"
